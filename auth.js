...
// CORRIGÉ : chemins relatifs pour GitHub Pages
// ============================================================
...
showMessage('🎉 Compte créé ! Connecte-toi maintenant.', 'success');

// Redirection vers login (chemin RELATIF)
setTimeout(() => {
...
// Redirection vers dashboard (chemin RELATIF)
setTimeout(() => {
...
// Redirection vers accueil (chemin RELATIF)
setTimeout(() => {
